        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <hr />
                    <div class="media">
                        <div class="d-flex flex-column vote-control pr-4">
                            <a  title="This question useful"  href="" class="vote-up">
                            ...
                            <a title="This question is not useful" href="" class="vote-down off">
                                <i class="fas fa-caret-down fa-3x"></i>
                                 ...
                                 <a title = "Click to add as favorite question (click again to undo)" href="" class="favorite mt-2 favorited">
                        ...
                        <div class="media">
                            ...
                            <a title="This answer is not useful" href="" class="vote-down off">
                                <i class="fas fa-caret-down fa-3x"></i>
                                 ...
                                 <a title = "Mark this as the best answer " href="" class="vote-accept mt-2">
